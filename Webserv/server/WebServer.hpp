...
private:
    ...
    void send_upload_success_response(int, const std::string &, size_t); // JESS: handles post request for frontend
    void send_upload_success_json(int client_fd,
                                             const std::string &full_filename,
                                             size_t i); // JESS: handles post request for frontend
